...
public class FileEncryptionManager {
    ...
    public void setRSAKey(String publicKey, String privateKey, boolean isEncode) throws Exception {
        if (isEncode){
            ...
            this.publicKey = com.blakequ.rsa.Base64Utils.encode(publicKey.getBytes());
            this.privateKey = com.blakequ.rsa.Base64Utils.encode(privateKey.getBytes());
        }
    }
    ...
    public void setRSAKey(RSAPublicKey publicKey, RSAPrivateKey privateKey) throws Exception {
        this.publicKey = com.blakequ.rsa.Base64Utils.encode(publicKey.getEncoded());
